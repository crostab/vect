...
export { zipper, mutazip, iterzip, duozipper, trizipper, quazipper }               from '@vect/matrix-zipper'
export { columns, columnsBy, columnsOf, columnsTo, columnsIterate, columnsMapper } from '@vect/columns-mapper'
