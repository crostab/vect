...
const Duozipper = (fn, lo, hi) => duozipper.bind({ fn, hi, lo });
const Trizipper = (fn, lo, hi) => trizipper.bind({ fn, hi, lo });
const Quazipper = (fn, lo, hi) => quazipper.bind({ fn, hi, lo });
