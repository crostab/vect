 ...
 * @constructor
 */
const ColumnMutate = (y) => columnMutate.bind({ y });
 ...
 * @constructor
 */
const ColumnMapper = (y, duplicate = true) => duplicate
  ? columnMapperDuplicate.bind({ y })
  : columnMapper.bind({ y });


function mutate(mx, y, fn, l) { return columnMutate.call({y}, mx, fn, l) }

function mapper(mx, y, fn, l) { return columnMapper.call({y}, mx, fn, l) }
...
export { ColumnIterate, ColumnMapper, ColumnMutate, indexed, indexedBy, indexedOf, indexedTo, iterate, mapper, mutate };
